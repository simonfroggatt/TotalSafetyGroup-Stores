...
use Braintree\Transaction\SubscriptionDetails;
use DateTime;
 ...
 * @property-read AmexExpressCheckoutCardDetails $amexExpressCheckoutCardDetails transaction Amex Express Checkout card info
 * @property-read AndroidPayCardDetails $androidPayCardDetails transaction Android Pay card info
 * @property-read ApplePayCardDetails $applePayCardDetails transaction Apple Pay card info
 * @property-read AuthorizationAdjustment[] $authorizationAdjustments populated when a transaction has authorization adjustments created when submitted for settlement
 ...
 * @property-read AddressDetails $billingDetails transaction billing address
 * @property-read string $channel
 * @property-read CoinbaseDetails $coinbaseDetails transaction Coinbase account info
 * @property-read DateTime $createdAt transaction created DateTime
 * @property-read CreditCardDetails $creditCardDetails transaction credit card info
 * @property-read string $currencyIsoCode
 * @property-read array $customFields custom fields passed with the request
 * @property-read CustomerDetails $customerDetails transaction customer info
 ...
 * @property-read Dispute[] $disputes populated when transaction is disputed
 * @property-read string $escrowStatus
 * @property-read FacilitatedDetails $facilitatedDetails
 * @property-read FacilitatorDetails $facilitatorDetails
 * @property-read string $gatewayRejectionReason
 * @property-read string $id transaction id
 * @property-read IdealPayment $idealPaymentDetails transaction Ideal Payment info
 * @property-read TransactionLineItem[] $lineItems
 * @property-read MasterpassCardDetails $masterpassCardDetails transaction Masterpass card info
 ...
 * @property-read PayPalDetails $paypalDetails transaction paypal account info
 ...
 * @property-read RiskData $riskData
 * @property-read SamsungPayCardDetails $samsungPayCardDetails transaction Samsung Pay card info
 * @property-read string $serviceFeeAmount
 * @property-read string $settlementBatchId
 * @property-read string $shippingAmount
 * @property-read AddressDetails $shippingDetails transaction shipping address
 * @property-read string $status transaction status
 * @property-read StatusDetails[] $statusHistory array of StatusDetails objects
 * @property-read SubscriptionDetails $subscriptionDetails
 ...
 * @property-read VenmoAccount $venmoAccountDetails transaction Venmo Account info
 * @property-read VisaCheckoutCardDetails $visaCheckoutCardDetails transaction Visa Checkout card info
