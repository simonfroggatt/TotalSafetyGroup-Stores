var bespokeSign = function(drawObject, options, drawing_width = 750, drawing_height = 750) {
  ...
  this.addNewTextBlack = function(textPanelID, textBlocklID, defaultText = '') {
    bespokeConstructor.newTextBlock(textPanelID, textBlocklID, defaultText);
    this.buildSign(true, '', false);
  };
...
*/
  ...
  this.changeTextSize = function(changeBy, textPanelID, textPanelBlockID, userTextIn) {
    ...
    bespokeConstructor.setTextBlockInfo(textPanelID, textPanelBlockID, newTextBlockInfo);
