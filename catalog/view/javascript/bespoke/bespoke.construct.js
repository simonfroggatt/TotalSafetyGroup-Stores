   ...
   return sizeChanged;
    ...
    this.setSymbol = function(symbolNumber, symbolPath, symbolInfo)
    {
        ...
        $.ajax({
            async: false,
            type: 'GET',
            url: 'index.php?route=bespoke/bespoke/load_svg',
...
this.newTextBlock = function(textPanelID, textBlockID, defaultText = '')
{
...
//  DEFAULT_FONT_HEIGHT_RATIO * textFrameHeight
  ...
  var newTextLine = {text: defaultText, colour: vars.textPanels[textPanelID].baseTextColour,
  weight: 'bold',
